...
namespace TSUE.Controllers
{
    public class LogoutController : Controller
    {
        ...
        private async Task<ClaimsPrincipal> ValidateLogoutToken(string logoutToken)
        {
            ...
            var logoutEvent = events.TryGetValue("http://schemas.openid.net/event/backchannel-logout", out test);
        ...
        private async Task<ClaimsPrincipal> ValidateJwt(string jwt)
        {
            ...
            var disco = await client.GetDiscoveryDocumentAsync(_configuration.GetSection("IdentityServer")["IdentityServerAuthority"]);
            ...
            var parameters = new TokenValidationParameters
            {
                ...
                ValidAudience = _configuration.GetSection("IdentityServer")["ClientId"],
