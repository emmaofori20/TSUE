    ...
    public partial class AddingIdentity : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK8", x => x.CategoryId)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CommenterName = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK2", x => x.CommentId)
                        .Annotation("SqlServer:Clustered", false);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ProjectId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ProjectDate = table.Column<DateTime>(type: "datetime", nullable: true),
                    ...
                    ProjectIcon = table.Column<byte[]>(type: "varbinary(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK1", x => x.ProjectId)
                        .Annotation("SqlServer:Clustered", false);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK9", x => x.ProjectCategoryId)
                        .Annotation("SqlServer:Clustered", false);
                    table.ForeignKey(
                        name: "RefCategory6",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK3", x => x.ProjectCommentId)
                        .Annotation("SqlServer:Clustered", false);
                    table.ForeignKey(
                        name: "RefComment1",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ProjectFileId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ProjectId = table.Column<int>(type: "int", nullable: false),
                    ProjectFileName = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    ProjectFile = table.Column<byte[]>(type: "varbinary(max)", nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    CreatedOn = table.Column<DateTime>(type: "datetime", nullable: false),
                    UpdatedBy = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    UpdatedOn = table.Column<DateTime>(type: "datetime", nullable: true)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK4", x => x.ProjectFileId)
                        .Annotation("SqlServer:Clustered", false);
                    table.ForeignKey(
                        name: "RefProject3",
                        column: x => x.ProjectId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectComment_CommentId",
